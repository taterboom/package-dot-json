...
export function LogosNpmIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
...
export function IconMdiGithub(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      xmlnsXlink="http://www.w3.org/1999/xlink"
...
export function MaterialSymbolsKeyboardBackspace(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 24 24" {...props}>
      <path fill="currentColor" d="m9 18l-6-6l6-6l1.4 1.4L6.8 11H21v2H6.8l3.6 3.6Z"></path>
    </svg>
  )
}
